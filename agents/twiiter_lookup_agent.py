...
def tool():
    t = [
        ...
        description="useful for when you need get the Twitter Page URL", # super super important, because that's how the llm is going to determine whether to use this tool or not
        )
    ]
    return t
